...
const drivers = [
  { id: "1", name: "James Okonkwo", cdl: "CDL-A #TX-84921", cdlClass: "Class A", state: "TX", status: "action" as Status, email: "j.okonkwo@email.com", joined: "Jan 12, 2024", docsExpiring: 1 },
  { id: "2", name: "Maria Santos", cdl: "CDL-B #TX-20381", cdlClass: "Class B", state: "TX", status: "action" as Status, email: "m.santos@email.com", joined: "Mar 5, 2024", docsExpiring: 1 },
  { id: "3", name: "Derek Holt", cdl: "CDL-A #TX-11204", cdlClass: "Class A", state: "TX", status: "action" as Status, email: "d.holt@email.com", joined: "Feb 18, 2024", docsExpiring: 1 },
  { id: "4", name: "Carlos Mendez", cdl: "CDL-A #MN-30921", cdlClass: "Class A", state: "MN", status: "compliant" as Status, email: "c.mendez@email.com", joined: "Nov 3, 2023", docsExpiring: 0 },
  { id: "5", name: "Sarah Kim", cdl: "CDL-A #MN-58203", cdlClass: "Class A", state: "MN", status: "compliant" as Status, email: "s.kim@email.com", joined: "Sep 22, 2023", docsExpiring: 0 },
  { id: "6", name: "Tony Reeves", cdl: "CDL-A #TX-48201", cdlClass: "Class A", state: "TX", status: "noncompliant" as Status, email: "t.reeves@email.com", joined: "Aug 7, 2023", docsExpiring: 0 },
  { id: "7", name: "Amanda Brooks", cdl: "CDL-B #TX-30912", cdlClass: "Class B", state: "TX", status: "noncompliant" as Status, email: "a.brooks@email.com", joined: "Oct 14, 2023", docsExpiring: 0 },
  { id: "8", name: "Priya Nair", cdl: "CDL-A #TX-93847", cdlClass: "Class A", state: "TX", status: "action" as Status, email: "p.nair@email.com", joined: "Dec 1, 2023", docsExpiring: 1 },
];
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium px-3 py-2 md:px-4 rounded-lg transition-colors">
          ...
          return (
            <div key={d.id} className="bg-white rounded-xl border border-gray-200 p-4">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-mono text-gray-400">{d.cdl}</p>
                  </div>
                </div>
              ...
              <div className="mt-3 flex items-center justify-between">
                <p className="text-xs text-gray-400">{d.cdlClass} · {d.state} · Joined {d.joined}</p>
                <button className="text-xs text-gray-600 px-3 py-1.5 border border-gray-200 rounded-lg">View</button>
              </div>
              {d.docsExpiring > 0 && (
                <p className="text-xs text-amber-600 font-medium mt-2">{d.docsExpiring} document expiring soon</p>
              )}
            </div>
          );
        })}
